...
public class ParentFunctionFeaturesPopularityMetric extends FeaturesPopularityMetric {

    public ParentFunctionFeaturesPopularityMetric(List<Snippet> snippets) {
        super(snippets);
    }
